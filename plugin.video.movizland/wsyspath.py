...
THISPLUG =Kodi_drive+ "/TSmediaTools/Kodi"
log_file=Kodi_drive+'/TSmediaTools/tmp/Kodi_log'
log_file1=Kodi_drive+'/TSmediaTools/tmp/Kodi_log1'
xbmclog_file=Kodi_drive+'/TSmediaTools/tmp/xbmclog.txt'
